...
const Landing: React.FC = () => {
    ...
    const handleJoinRoom = async (event: React.MouseEvent<HTMLButtonElement>) => {
        ...
        const isRoomCodeValid = (await axios.get(`https://68.183.135.205:5001/isRoomCodeValid?roomCode=${roomCode}`)).data;
        if(isRoomCodeValid) {
    ...
    const handleCreateRoom = async (event: React.MouseEvent<HTMLButtonElement>) => {
        ...
        const newCode = (await axios.get('https://68.183.135.205:5001/roomcode')).data;
